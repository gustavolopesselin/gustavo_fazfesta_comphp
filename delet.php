...
if ((isset($_GET['id_usuario'])) && ($_GET['id_usuario'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tb_usuario WHERE id_usuario=%s",
                       GetSQLValueString($_GET['id_usuario'], "int"));

  mysql_select_db($database_conexaobanco, $conexaobanco);
  $Result1 = mysql_query($deleteSQL, $conexaobanco) or die(mysql_error());

  $deleteGoTo = "controleusuario.php";
