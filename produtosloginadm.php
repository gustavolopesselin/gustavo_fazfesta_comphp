            ...
            <table class="tabelaprodutos">
               ...
               <?php do { ?>
                <tr>
                  ...
                  <td><button class="buttontabelaproduro" type="button" onClick="location. href='uploadproduto.php?id_produto=<?php echo $row_selectproduto['id_produto']; ?>'">Alterar</button></td>
                  <td><button type="button" onClick="location. href='deletproduto.php?id_produto=<?php echo $row_selectproduto['id_produto']; ?>'">Deletar</button></td>
                  </tr>
